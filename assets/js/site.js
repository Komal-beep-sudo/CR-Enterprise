...
{id:102,cat:"Sharp Containers",tag:"Sharp Container",name:"Sharps Container 1.1 Litre",desc:"1.1 litre translucent needle disposal container marked &lsquo;For Sharp Objects Only&rsquo;. Ideal biomedical sharps waste container for dressing rooms, dental clinics and vaccination centres.",price:"Price on Request",img:"assets/img/cr-0058.webp",feat:["Most economical sharps waste container","Meets Biomedical Waste Management norms","Solid &amp; stable shape","Puncture resistant","Ergonomic handle","Indents for needle removal","Temporary closure with visibility of the inside","Permanent closing facility","Maximum filling level indicator","Made in India"]},
  {id:325,cat:"Sharp Containers",tag:"Sharp Container",name:"Sharps Container 1.3 Litre",desc:"1.3 litre disposable sharp container with a translucent hinged flap lid and wide drop-in aperture for single-hand disposal of used syringes, needles and sharps. Puncture-resistant, leak-proof body printed with the &lsquo;do not fill above this line&rsquo; warning and biohazard marking, with a tamper-evident closure for transport to disposal.",price:"Price on Request",img:"assets/img/cr-0309.webp",feat:["Translucent hinged flap lid", "Wide drop-in aperture for syringes &amp; needles", "Puncture-resistant &amp; leak-proof body", "Tamper-evident final closure", "Available in yellow, red, blue &amp; translucent white", "Single use &mdash; destroy by incineration"]},
  {id:331,cat:"Sharp Containers",tag:"Sharp Container",name:"Sharps Container 1.5 Litre &ndash; Biohazard Labelled",desc:"1.5 litre disposable sharps container with a printed biohazard warning panel, fill-line marking and discard date and time fields. Puncture-resistant, leak-proof body with a snap-fit lid for the safe collection of syringes, needles, blades, razors, broken glass, ampoules, staples and trocars. Available in yellow, red, blue and translucent white.",price:"Price on Request",img:"assets/img/cr-0305.webp",feat:["Colour coded &ndash; yellow, red, blue &amp; translucent white","1.5 litre capacity","Puncture resistant &amp; leak proof","Printed &lsquo;do not fill above the line&rsquo; marking","Biohazard warning panel with discard date &amp; time","Snap-fit lid with permanent closure","Single use only &mdash; destroy by incineration","As per CPCB &amp; BMW Management Rules, 2016"]},
...
{id:103,cat:"Sharp Containers",tag:"Sharp Container",name:"Sharps Container 3.5 Litre",desc:"3.5 litre disposable sharp container with date, department and sign panel. Puncture-proof needle and blade disposal bin for hospital wards, OPDs and pathology labs. Single use only, as per Government Rules.",price:"Price on Request",img:"assets/img/cr-0062.webp",feat:["Most economical sharps waste container","Meets Biomedical Waste Management norms","Solid &amp; stable shape","Puncture resistant","Ergonomic handle","Indents for needle removal","Temporary closure with visibility of the inside","Permanent closing facility","Maximum filling level indicator","Made in India"]},
  {id:328,cat:"Sharp Containers",tag:"Sharp Container",name:"Sharps Container 5 Litre",desc:"5 litre colour-coded sharps container with clear hinged lid, central drop-in aperture and moulded carry handle. Puncture-resistant, leak-proof needle and syringe disposal container for wards, dressing rooms, laboratories and dialysis units. Available in yellow, red, blue and white for BMW Rules, 2016 colour-coded segregation.",price:"Price on Request",img:"assets/img/cr-0287.webp",feat:["Colour coded &ndash; yellow, red, blue &amp; white","Meets Biomedical Waste Management norms","Puncture resistant &amp; leak proof","Clear hinged lid with drop-in aperture","Moulded carry handle","Permanent closing facility","Maximum filling level indicator","Made in India"]},
{id:105,cat:"Sharp Containers",tag:"Sharp Container",name:"Sharps Container 6 Litre",desc:"7.5 litre disposable sharp container for high-volume sharps generation areas. Puncture-resistant, leak-proof needle disposal container for operation theatres, ICUs and dialysis centres. Mfg. in accordance with IS 7320.",price:"Price on Request",img:"assets/img/cr-0321.webp",feat:["Most economical sharps waste container","Meets Biomedical Waste Management norms","Solid &amp; stable shape","Puncture resistant","Ergonomic handle","Indents for needle removal","Temporary closure with visibility of the inside","Permanent closing facility","Maximum filling level indicator","Made in India"]},
  {id:104,cat:"Sharp Containers",tag:"Sharp Container",name:"Sharps Container 7 Litre",desc:"6.5 litre sharp waste container with wide blue snap lid and carrying handle. Heavy-duty biomedical sharps bin for busy hospital wards, ICUs and blood collection centres.",price:"Price on Request",img:"assets/img/cr-0063.webp",feat:["Most economical sharps waste container","Meets Biomedical Waste Management norms","Solid &amp; stable shape","Puncture resistant","Ergonomic handle","Indents for needle removal","Temporary closure with visibility of the inside","Permanent closing facility","Maximum filling level indicator","Made in India"]},
  {id:326,cat:"Sharp Containers",tag:"Sharp Container",name:"Sharps Container 10 Litre",desc:"10 litre colour-coded sharps container with locking lid and carry handle. Puncture-resistant, leak-proof needle and syringe disposal container for wards, operation theatres and high-volume collection points. Available in yellow, red, blue and white to suit BMW Rules, 2016 colour-coded segregation.",price:"Price on Request",img:"assets/img/cr-0271.webp",feat:["Colour coded &ndash; yellow, red, blue &amp; white","Meets Biomedical Waste Management norms","Puncture resistant &amp; leak proof","Locking lid with central closure","Sturdy carry handle","Solid &amp; stable shape","Easy to transport and store","Made in India"]},
  {id:107,cat:"Sharp Containers",tag:"Pharma Waste Container",name:"Sharp Container 12.5 L",desc:"12.5 litre blue non-hazardous pharmaceutical waste container for hospital pharmacies, nursing homes and medical stores. Leak-proof, tamper-evident lid with wide top opening.",price:"Price on Request",img:"assets/img/cr-0064.webp",feat:["For non-hazardous pharmaceutical waste only","Transparent hinged lid with wide opening","Date / Dept. / Sign record panel","Puncture resistant &amp; leak proof","Solid, stable and stackable shape","Ergonomic side handles","Single use only","Made in accordance with BMW Management Rules","Made in India"]},
  {id:327,cat:"Sharp Containers",tag:"Sharp Container",name:"Sharps Container 15 Litre",desc:"15 litre colour-coded sharps container with hinged flip-top lid, screw-on collar and twin side handles. Puncture-resistant, leak-proof needle and syringe disposal container for operation theatres, ICUs, dialysis units and other high-volume sharps generation areas. Available in yellow, red, blue and white for BMW Rules, 2016 colour-coded segregation.",price:"Price on Request",img:"assets/img/cr-0275.webp",feat:["Colour coded &ndash; yellow, red, blue &amp; white","Meets Biomedical Waste Management norms","Puncture resistant &amp; leak proof","Hinged flip-top lid for one-hand disposal","Screw-on collar with permanent closure","Twin side handles for safe transport","Maximum filling level indicator","Made in India"]},
{id:108,cat:"Sharp Containers",tag:"Pharma Waste Container",name:"Non-Hazardous Pharmaceutical Waste Container 25 L",desc:"25 litre high-capacity pharmaceutical waste bin for bulk disposal of expired medicines and discarded drugs. Ideal for hospital pharmacies, pharmaceutical units and large healthcare facilities.",price:"Price on Request",img:"assets/img/cr-0065.webp",feat:["For non-hazardous pharmaceutical waste only","Transparent hinged lid with wide opening","Date / Dept. / Sign record panel","Puncture resistant &amp; leak proof","Solid, stable and stackable shape","Ergonomic side handles","Single use only","Made in accordance with BMW Management Rules","Made in India"]},
  {id:332,cat:"Sharp Containers",tag:"Sharp Container",name:"Sharps Container 60 Litre",desc:"60 litre high-capacity sharps container with a removable lid and central rotating closure. Puncture-resistant, leak-proof ribbed body with moulded side grips, sized for operation theatres, ICUs and central collection points where sharps volumes are highest. Available in yellow, red, blue and white for BMW Rules, 2016 colour-coded segregation.",price:"Price on Request",img:"assets/img/cr-0313.webp",feat:["Colour coded &ndash; yellow, red, blue &amp; white","60 litre capacity","Puncture resistant &amp; leak proof","Removable lid with central rotating closure","Reinforced ribbed body for stacking strength","Moulded side grips for two-person handling","For high-volume theatre, ICU &amp; CSSD collection","Meets Biomedical Waste Management norms","Made in India"]},
{id:131,cat:"Sharp Safety Box",tag:"Safety Box",name:"Sharp Safety Box &ndash; Blue",desc:"Fold-assemble cardboard safety box for the disposal of used syringes, needles, sharps and blades. Blue outer with pre-printed biohazard symbol, &lsquo;FULL&rsquo; fill line and an integrated carry handle. Assembly, closure and handling instructions are printed on the box. For single use and incineration.",price:"Price on Request",img:"assets/img/cr-0258.webp",feat:["Container for used syringes, needles, sharps &amp; blades","Pre-printed biohazard symbol","&lsquo;FULL&rsquo; fill-line marked on all sides","Integrated carry handle for safe transport","Printed instructions: assembling, closing &amp; sealing, handling, temporary closure, final closure","Temporary closure and tamper-evident final closure","Single use &mdash; do not reuse, do not overfill","For incineration once filled to the indicated line"]},
{id:132,cat:"Sharp Safety Box",tag:"Safety Box",name:"Sharp Safety Box &ndash; Yellow",desc:"Fold-assemble cardboard safety box for the disposal of used syringes, needles, sharps and blades. Yellow outer with pre-printed biohazard symbol, &lsquo;FULL&rsquo; fill line and an integrated carry handle. Assembly, closure and handling instructions are printed on the box. For single use and incineration.",price:"Price on Request",img:"assets/img/cr-0259.webp",feat:["Container for used syringes, needles, sharps &amp; blades","Pre-printed biohazard symbol","&lsquo;FULL&rsquo; fill-line marked on all sides","Integrated carry handle for safe transport","Printed instructions: assembling, closing &amp; sealing, handling, temporary closure, final closure","Temporary closure and tamper-evident final closure","Single use &mdash; do not reuse, do not overfill","For incineration once filled to the indicated line"]},
{id:109,cat:"Waste Bins With Foot Pedals & Wheels",tag:"Waste Bins",name:"Waste Bin with Foot Pedal &ndash; Colour Coded Set",desc:"Colour-coded pedal dustbins in red, yellow, blue and black with biohazard marking. Hands-free foot-operated hospital waste bins that support BMW Rules, 2016 colour-coded segregation and reduce cross-contamination.",price:"Price on Request",img:"assets/img/cr-0066.webp",feat:["Available in red, yellow, blue &amp; black","Hands-free foot pedal operation","Pre-printed biohazard symbol","Supports colour-coded waste segregation","Durable virgin plastic body","Easy to clean and disinfect","Removable inner liner holder","Suitable for hospitals, clinics &amp; labs","Made in India"]},
...
{id:129,cat:"Waste Bins With Foot Pedals & Wheels",tag:"Waste Bins",name:"80 Litre Dustbin",desc:"80 litre pedal dustbin available in blue and green. Large hands-free foot-operated waste bin ideal for wards, corridors and high-footfall areas, supporting BMW Rules, 2016 colour-coded segregation.",price:"Price on Request",img:"assets/img/cr-0071.webp",feat:["Available in blue &amp; green","80 litre high capacity","Hands-free foot pedal operation","Sturdy reinforced body","Supports colour-coded waste segregation","Durable virgin plastic body","Easy to clean and disinfect","Ideal for hospitals &amp; institutions","Made in India"]},

{id:125,cat:"Waste Bins With Foot Pedals & Wheels",tag:"Waste Bins",name:"120 Litre Wheeled Dustbin",desc:"120 litre two-wheeled mobile dustbin available in blue and green. Large-capacity wheelie bin with hinged lid for easy outdoor and bulk waste collection across hospitals, campuses and municipal areas, supporting colour-coded segregation.",price:"Price on Request",img:"assets/img/cr-0072.webp",feat:["Available in blue &amp; green","120 litre high capacity","Two sturdy wheels for easy mobility","Hinged lid with moulded handles","UV-stabilised virgin HDPE body","Supports colour-coded waste segregation","Easy to clean and disinfect","Ideal for outdoor &amp; bulk waste","Made in India"]},

{id:130,cat:"Waste Bins With Foot Pedals & Wheels",tag:"Waste Bins",name:"120 Litre Pedal Dustbin",desc:"120 litre pedal dustbin available in blue and green. Tall hands-free foot-operated waste bin with hinged lid, ideal for wards, corridors and high-footfall areas, supporting BMW Rules, 2016 colour-coded segregation.",price:"Price on Request",img:"assets/img/cr-0283.webp",feat:["Available in blue &amp; green","120 litre high capacity","Hands-free foot pedal operation","Hinged lid with moulded handles","Sturdy reinforced body","Supports colour-coded waste segregation","Durable virgin plastic body","Ideal for hospitals &amp; institutions","Made in India"]},

{id:126,cat:"Waste Bins With Foot Pedals & Wheels",tag:"Waste Bins",name:"660 Litre Wheeled Container",desc:"660 litre four-wheeled waste container available in blue, red, yellow and silver. Heavy-duty mobile bin with hinged lid and lockable castors for bulk waste storage across hospitals, campuses and industrial sites, supporting colour-coded segregation.",price:"Price on Request",img:"assets/img/cr-0074.webp",feat:["Available in blue, red, yellow &amp; silver","660 litre bulk capacity","Four heavy-duty castors, two lockable","Hinged lid with central handle","Reinforced ribbed body for strength","UV-stabilised virgin HDPE body","Supports colour-coded waste segregation","Ideal for bulk &amp; industrial waste","Made in India"]},

{id:127,cat:"Waste Bins With Foot Pedals & Wheels",tag:"Waste Bins",name:"1100 Litre Wheeled Container",desc:"1100 litre four-wheeled bulk waste container with hinged flat lid and lockable castors. The largest capacity mobile bin in the range, built for high-volume waste storage across hospitals, campuses, industrial and municipal sites.",price:"Price on Request",img:"assets/img/cr-0075.webp",feat:["1100 litre maximum bulk capacity","Four heavy-duty castors, two lockable","Hinged flat lid for stacking","Reinforced ribbed body for strength","UV-stabilised virgin HDPE body","High load-bearing capacity","Easy to manoeuvre when loaded","Ideal for bulk &amp; industrial waste","Made in India"]},
  {id:111,cat:"Waste Bins With Foot Pedals & Wheels",tag:"Waste Bins",name:"4 Wheeled Plastic Dustbin",desc:"Large capacity 4 wheeled plastic dustbin with lockable castors and flat hinged lid. Bulk waste container for hospitals, institutions, industries and municipal biomedical waste collection points.",price:"Price on Request",img:"assets/img/cr-0077.webp",feat:["Four heavy-duty castors, two with brakes","Flat hinged lid for stacking","High load-bearing capacity","UV-stabilised virgin HDPE body","Smooth interior for easy cleaning","Suitable for bulk waste collection","Ideal for hospitals &amp; institutions","Made in India"]},
  {id:133,cat:"Wringer Mop Trolleys",tag:"Mop Trolley",name:"Wringer Mop Trolley &ndash; Triple Bucket (36 Litre)",desc:"Triple-bucket wringer mop trolley with 36 litre capacity, built on a tubular metal frame with swivel castors and a push handle. Colour-coded buckets keep clean and dirty water separate, and the down-press wringer sits centrally between them. For hospital, laboratory and facility housekeeping.",price:"Price on Request",img:"assets/img/cr-0260.webp",feat:["Triple bucket configuration","36 litre capacity","Heavy-duty down-press mop wringer","Colour-coded buckets for clean &amp; dirty water","Separate buckets prevent cross-contamination","Tubular metal frame with push handle","Swivel castors for easy manoeuvring","Ideal for hospitals, laboratories &amp; facility housekeeping"]},
{id:134,cat:"Wringer Mop Trolleys",tag:"Mop Trolley",name:"Wringer Mop Trolley &ndash; Triple Bucket (48 Litre)",desc:"Triple-bucket wringer mop trolley with 48 litre capacity, built on a tubular metal frame with swivel castors and a push handle. Colour-coded buckets keep clean and dirty water separate, and the down-press wringer sits centrally between them. For hospital, laboratory and facility housekeeping.",price:"Price on Request",img:"assets/img/cr-0261.webp",feat:["Triple bucket configuration","48 litre capacity","Heavy-duty down-press mop wringer","Colour-coded buckets for clean &amp; dirty water","Separate buckets prevent cross-contamination","Tubular metal frame with push handle","Swivel castors for easy manoeuvring","Ideal for hospitals, laboratories &amp; facility housekeeping"]},
{id:135,cat:"Emergency Trolley / Crash Cart",tag:"Crash Cart",name:"Emergency Trolley (Crash Cart) &ndash; ABS",desc:"ABS moulded emergency trolley with a stainless steel work top and four drawers finished with red, blue, green and yellow colour-coded handles for rapid identification. Eleven clear tilt-out bins are mounted in two rows on the stainless steel push handle frame, keeping consumables visible and within reach. Central locking, on four swivel castors.",price:"Price on Request",img:"assets/img/cr-0264.webp",feat:["Moulded ABS body with stainless steel work top","Four drawers with colour-coded handles","Central locking for all drawers","Eleven clear tilt-out bins in two rows","Stainless steel push handle frame","Rounded, easy-clean mouldings","Four swivel castors"]},
...
{id:115,cat:"Hospital Waste Collection Bags",tag:"Hospital Waste Collection Bags",name:"Steam Autoclavable Bags &ndash; Colour Coded",desc:"Colour-coded steam autoclavable biohazard bags in yellow, green, red, blue and black. Autoclavable biomedical waste bags that withstand steam sterilisation before final disposal, as per BMW colour-coding.",price:"Price on Request",img:"assets/img/cr-0093.webp",feat:["Available in yellow, green, red, blue &amp; black","Withstands steam autoclaving","Printed biohazard waste symbol","Leak proof, high tensile strength","Supports BMW colour-coded segregation","Multiple sizes and micron options","For hospitals, labs &amp; blood banks","Made in India"]},
  {id:340,cat:"Spill Kits",tag:"Spill Kit",name:"Blood &amp; Body Fluid Spill Kit",desc:"Complete carry-case spill kit for the safe containment, disinfection and disposal of blood and body fluid spillages in wards, laboratories, ambulances and public areas. Supplied in a latched, compartmented case so every component stays together and ready for immediate use.",price:"Price on Request",img:"assets/img/cr-0284.webp",feat:["Latched carry case with compartmented tray","Absorbent granules &amp; absorbent pads","Disinfectant solution","Nitrile examination gloves","Face mask &amp; protective apron","Scoop and scraper for solid pick-up","Yellow biohazard disposal bags with tie","Step-by-step instruction card","Single use &mdash; dispose as biomedical waste","Made in India"]},
  {id:341,cat:"Spill Kits",tag:"Spill Kit",name:"Mercury Spill Kit",desc:"Carry-case kit for the safe recovery and containment of mercury spillages from broken thermometers, sphygmomanometers and laboratory apparatus. Contains everything required to collect, neutralise and seal mercury for safe onward disposal.",price:"Price on Request",img:"assets/img/cr-0285.webp",feat:["Latched carry case with compartmented tray","Mercury absorbent / suppressant powder","Sealable collection container with screw lid","Nitrile examination gloves","Face mask &amp; protective apron","Scoop, scraper and applicator","Disposal bags with ties","Step-by-step instruction card","Single use &mdash; dispose as hazardous waste","Made in India"]},
  ...
  {id:317,cat:"Hub Cutter & Needle Destroyer",tag:"Hub Cutter & Needle Destroyer",name:"Needle Hub Cutter with Stand &ndash; 1.5 Litre",desc:"1.5 litre needle hub cutter mounted on a stainless steel stand. The lever-operated cutter severs the needle hub and drops the cut sharps straight into the sealed container below, so they are never handled. Compact footprint for dressing trolleys, bedsides and phlebotomy rooms.",price:"Price on Request",img:"assets/img/cr-0304.webp",feat:["Stainless steel cutter assembly with lever handle","1.5 litre sealed container below the cutter","Cut needles drop straight in &ndash; no handling","Stainless steel stand for bench stability","Hinged lid with locking clips","Compact footprint for trolleys and bedsides","Easy to clean and disinfect","Meets Biomedical Waste Management norms"]},
...
/* ===== PROPORTIONAL PRODUCT SIZING ==================================
   Sharps containers are photographed individually, so every image fills
   its own frame and a 600 ML bin looks the same size as a 25 L one.
   Rendered size is scaled by the CUBE ROOT of capacity, because height
   grows with the cube root of volume - a 25 L bin is only ~3.4x taller
   than a 600 ML one, not 42x. Mapped onto a 55-100% band so the
   smallest item stays clearly legible.                                  */
var CR_VOL_L = {
  101: 0.6, 102: 1.1, 325: 1.3, 331: 1.5, 320: 1.5, 324: 1.5, 103: 3.5,
  328: 5, 105: 6, 104: 7, 326: 10, 107: 12.5, 327: 15, 108: 25, 332: 60
};
var CR_VOL_MIN = 0.6, CR_VOL_MAX = 60, CR_SIZE_FLOOR = 40, CR_SIZE_CEIL = 120;
...
var CR_SIZE_OVERRIDE = {
  /* hub cutters & needle destroyers - cube-root ladder, 300 ML to 7 L */
  314: 42, 315: 44, 316: 51, 310: 67, 317: 67, 311: 87, 312: 97, 313: 108
,
  /* 15 L photo is narrow/portrait - lift it off the ladder so it reads
     as tall as the 25 L beside it */
  327: 87,
  /* 60 L shot includes a detached lid, so the bin itself reads small -
     lift the whole image well above the ladder */
  332: 100
};
...
function volScale(id) {
  ...
  var v = CR_VOL_L[id];
  if (!v) return null;                     // capacity unknown - leave at 100%
  var cbrt = function (x) { return Math.pow(x, 1 / 3); };
  var r = (cbrt(v) - cbrt(CR_VOL_MIN)) / (cbrt(CR_VOL_MAX) - cbrt(CR_VOL_MIN));
  return Math.round((CR_SIZE_FLOOR + r * (CR_SIZE_CEIL - CR_SIZE_FLOOR)) * 10) / 10;
}
...
function buildProds() {
  ...
  for (var i = 0; i < filtered.length; i++) {
    var p = filtered[i];
    var _vs = volScale(p.id);
    var pSize = _vs ? _vs + '%' : '100%';
    html += '<div class="pcard">';
    if (p.img) {
      html += '<div class="pimg" style="background:#fff;padding:10px;"><img ' + (p.id === 100 ? 'id="famImg" ' : p.id === 102 ? 'id="c11Img" ' : p.id === 101 ? 'id="c600Img" ' : p.id === 103 ? 'id="c35Img" ' : p.id === 104 ? 'id="c65Img" ' : p.id === 120 ? 'id="c125Img" ' : p.id === 105 ? 'id="c75Img" ' : p.id === 121 ? 'id="c25Img" ' : p.id === 108 ? 'id="ph25Img" ' : p.id === 107 ? 'id="ph125Img" ' : AC_SLIDES[p.id] ? 'id="acImg' + p.id + '" ' : '') + 'src="' + p.img + '" alt="' + p.name + ' - CRENEU biomedical waste product" loading="lazy" decoding="async" onload="this.classList.add(\'ld\')" onerror="this.classList.add(\'ld\')" style="max-width:' + pSize + ';max-height:' + pSize + ';object-fit:contain;"><span class="ptag">' + (p.tag || p.cat) + '</span></div>';
    } else {
...
var C600_EXTRA = ["assets/img/cr-0318.webp","assets/img/cr-0319.webp","assets/img/cr-0320.webp"];
var _c600Timer = null;
...
var C75_EXTRA = ["assets/img/cr-0322.webp","assets/img/cr-0323.webp","assets/img/cr-0324.webp"];
...
function startC75Slider() {
  ...
  for (var e = 0; e < C75_EXTRA.length; e++) slides.push(C75_EXTRA[e]);
  if (slides.length < 2) return;
  var idx = 2;
  im.src = '' + slides[idx];
...
function markLoadedImages() {
  var im = document.querySelectorAll('.pimg img:not(.ld)');
  for (var i = 0; i < im.length; i++) { if (im[i].complete) im[i].classList.add('ld'); }
}
...
function setCat(c) {
  ...
  buildCats(); buildProds(); updateProdCount(); fillGridGaps(); markLoadedImages();
...
function clearTranslateCookie() {
  // googtrans may exist on several scopes (pathless, host, dot-domain). If any
  // stale copy survives, Google reads that one and the page keeps the old
  // language - so every scope has to be cleared before a new value is written.
  var expire = ';expires=Thu, 01 Jan 1970 00:00:00 GMT;path=/';
  var host = location.hostname || '';
  var scopes = [''];
  if (host && host.indexOf('.') > -1) {
    scopes.push(';domain=' + host);
    scopes.push(';domain=.' + host.replace(/^www\./, ''));
  }
  for (var i = 0; i < scopes.length; i++) {
    document.cookie = 'googtrans=' + expire + scopes[i];
  }
}

function setTranslateCookie(code) {
  clearTranslateCookie();
  if (code === 'en') return;            // no cookie at all = original English
  var value = '/en/' + code;
...
function syncLanguageDropdown(code) {
  ...
  for (var i = 0; i < opts.length; i++) {
    ...
    if (click.indexOf("selectLang('" + code + "'") !== -1) {
      var img = opts[i].querySelector('img');
      if (lf && img) lf.src = img.getAttribute('src');
      break;
    }
  }
...
if (document.readyState === 'loading') {
  document.addEventListener('DOMContentLoaded', initCreneuTranslation);
} else {
  initCreneuTranslation();
}
...
var CLIENTS = [{"n": "Venkateshwara Medical College", "i": "assets/img/cr-0236.webp"}, {"n": "Army Hospital (Research &amp; Referral)", "i": "assets/img/cr-0237.webp"}, {"n": "Sanjay Gandhi Hospital", "i": "assets/img/cr-0238.webp"}, {"n": "Civil Hospital Rajkot", "i": "assets/img/cr-0239.webp"}, {"n": "Safdarjung Hospital", "i": "assets/img/cr-0240.webp"}, {"n": "All India Institute of Medical Sciences", "i": "assets/img/cr-0241.webp"}, {"n": "Geetanjali Hospital", "i": "assets/img/cr-0242.webp"}, {"n": "BLK Super Speciality Hospital", "i": "assets/img/cr-0243.webp"}, {"n": "PGI Chandigarh", "i": "assets/img/cr-0244.webp"}, {"n": "GCS Medical College Ahmedabad", "i": "assets/img/cr-0245.webp"}, {"n": "Deen Dayal Upadhyaya Hospital", "i": "assets/img/cr-0246.webp"}, {"n": "Narayana Hospital Katra", "i": "assets/img/cr-0267.webp"}, {"n": "Global Eye Hospital", "i": "assets/img/cr-0248.webp"}, {"n": "Gujarat Cancer &amp; Research Institute", "i": "assets/img/cr-0249.webp"}, {"n": "GB Pant Hospital", "i": "assets/img/cr-0250.webp"}, {"n": "GS Medical College &amp; Hospital", "i": "assets/img/cr-0251.webp"}, {"n": "Khetarpal Hospital", "i": "assets/img/cr-0252.webp"}, {"n": "Sardar Vallabhbhai Patel Hospital", "i": "assets/img/cr-0253.webp"}, {"n": "Sir Ganga Ram Hospital", "i": "assets/img/cr-0254.webp"}, {"n": "Fortis Healthcare", "i": "assets/img/cr-0255.webp"}, {"n": "Universal Hospitals", "i": "assets/img/cr-0256.webp"}, {"n": "Centre for Sight", "i": "assets/img/cr-0257.webp"}, {"n": "Sevayatan Hospital", "i": "assets/img/cr-0266.webp"}, {"n": "Max Healthcare", "i": "assets/img/cr-0286.webp"}];
...
/* ===== CONTACT FORM -> WHATSAPP =====================================
   The form has no server behind it, so the enquiry is composed into a
...
function sendContactWhatsApp() {          // name kept so existing markup is untouched
  ...
  var focus = function (id) {
    var el = document.getElementById(id);
    if (el) { el.focus(); el.style.borderColor = '#D64545'; setTimeout(function () {
      el.style.borderColor = '#eef2f7'; }, 2500); }
  };

  if (g('cf-company')) return;              // honeypot tripped - silently ignore

  var name = g('cf-name'), email = g('cf-email'), msg = g('cf-message');
  var phone = g('cf-phone'), subject = g('cf-subject');

  if (!name)  { toast('Please enter your name');            focus('cf-name');    return; }
  if (!email) { toast('Please enter your email address');   focus('cf-email');   return; }
  ...
  var back = isWeb ? (location.origin + location.pathname + '?sent=1') : '';
  var fields = {
    name: name,
    email: email,
    phone: phone || '-',
  ...
  if (back) fields._next = back;          // FormSubmit rejects a non-matching origin
...
function crContactSentNotice() {
  ...
  var form = document.getElementById('cf-name');
  form = form ? form.closest('form, section, div') : null;

  var box = document.createElement('div');
  box.setAttribute('role', 'status');
  box.style.cssText = 'max-width:620px;margin:26px auto;padding:22px 26px;border-radius:14px;' +
    'background:#e9f8f1;border:1px solid #9fdcc2;text-align:center;font-family:Outfit,sans-serif';
  box.innerHTML = '<div style="font-size:1.8rem;line-height:1;margin-bottom:8px">&#10003;</div>' +
    '<div style="font-weight:800;font-size:1.25rem;color:#0B1D3A;margin-bottom:6px">Message Sent</div>' +
    '<div style="font-size:.95rem;color:#3d6b56">Thank you for reaching out. Our team will get ' +
    'back to you within 24 hours.</div>';

  var anchor = document.querySelector('#cf-name');
  if (anchor) {
    var card = anchor.closest('div');
    while (card && card.parentElement && card.offsetWidth < 300) card = card.parentElement;
    (card && card.parentElement ? card.parentElement : document.body).insertBefore(box, card || null);
